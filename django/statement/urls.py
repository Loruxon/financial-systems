...
urlpatterns = [
    ...
    path('admin/transfers/receipts/', views.AdminTransferReceiptListView.as_view(), name='admin-transfer-receipt-list'),
    path('admin/transfers/<int:pk>/', views.AdminBankTransferDetailView.as_view(), name='admin-transfer-detail'),
    path('admin/transfers/<int:pk>/documents/', views.AdminTransferDocumentListView.as_view(), name='admin-transfer-document-list'),
    path('admin/transfer-documents/<int:pk>/', views.AdminTransferDocumentDetailView.as_view(), name='admin-transfer-document-detail'),
